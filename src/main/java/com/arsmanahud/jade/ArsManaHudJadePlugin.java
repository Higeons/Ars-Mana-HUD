 ...
 * <p>
 * Packs that replace Jade's plugin scan with a whitelist never reach this class;
 * {@link JadeDirectRegistration} re-registers the same providers directly on
 * Jade's registration singleton as a fallback.
 */
