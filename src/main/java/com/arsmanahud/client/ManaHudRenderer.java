...
public final class ManaHudRenderer {
    ...
    public static void render(GuiGraphics guiGraphics, DeltaTracker deltaTracker) {
        ...
        // Feature 5: estimated mana cost of the selected spell for held caster tools.
        renderSpellCost(minecraft, guiGraphics);
    }

    /**
     * Feature 5: render the estimated mana cost of the selected spell for the held
    ...
    private static void renderSpellCost(Minecraft minecraft, GuiGraphics guiGraphics) {
        ...
        AbstractCaster<?> caster = SpellCasterRegistry.from(casterStack);
        if (caster == null) {
            return;
        }
        ...
        String name = casterStack.getItem() instanceof SpellBook
                ? slot + 1 + " " + caster.getSpellName(slot)
                : caster.getSpellName(slot);
